...
class AuditEventQueryValidationIT {
    ...
    /** AC-F1d — actor filter accepts at most 10 distinct non-blank values. */
    @Test
    void actorFilter_moreThanTenDistinctActors_returns400() {
        assertBadRequest("/audit-events?actor=a1,a2,a3,a4,a5,a6,a7,a8,a9,a10,a11");
    }

    /** AC-E11 — duplicate raw tokens do not count against the distinct actor limit. */
    @Test
    void actorFilter_moreThanTenRawTokensWithDuplicates_returns200() {
        ResponseEntity<String> response =
                authed.getForEntity("/audit-events?actor=a1,a2,a3,a4,a5,a6,a7,a8,a9,a10,a1,a2,,", String.class);
        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
    }
